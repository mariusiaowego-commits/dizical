...
| v1.4.0-dev | — | — | 未冻结, 已并入 v1.5.0-dev: 聚光灯再减 (`--ccg-light-gain` 0.40) / 静止无光照 (lit 独占驱动) / 说明栏内下留白 `--plate-pad-b` / 跟手幅度加大 (22°+20px) | — |

> 开发中 (未冻结): **v1.5.0-dev** (dad 2026-09-13 四轮, 只动光照) —— 「鼠标移动上去后光照感一下子特别强,
> 特别白」。①**聚光灯总强度再砍 60%**: `--ccg-light-gain` **0.40 → 0.16** (相对原始 −84%);
...
1. 动手前先看 demo 页右上角 chip，确认现在是第几版 (当前 `v1.5.0-dev`)。
