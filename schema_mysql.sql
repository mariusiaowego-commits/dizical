...
CREATE TABLE achievements (
    ...
    created_at        DATETIME DEFAULT CURRENT_TIMESTAMP
, achieved_at_override TEXT, display_on_achievements BIGINT DEFAULT 1, sort_order_override BIGINT, card_theme TEXT NULL, card_stars BIGINT NULL, card_no BIGINT NULL, UNIQUE KEY idx_achievements_card_no (card_no));
